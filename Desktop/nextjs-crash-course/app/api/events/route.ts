    ...
    try{
        ...
        let event;
            ...
            const uploadResult = await new Promise((resolve, reject) => {
                cloudinary.uploader.upload_stream({ resource_type: 'image', folder:'StudEvent'}, (error,results)=> {
...
export async function GET(){
    try{
        ...
        return NextResponse.json({message: 'Failed fetching the Event', error: e}, {status: 500});
    }
}